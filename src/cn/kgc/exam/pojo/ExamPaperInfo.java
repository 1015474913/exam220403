...
public class ExamPaperInfo {
	...
	public String toString() {
		return "ExamPaperInfo [examPaperId=" + examPaperId + ", examPaperName=" + examPaperName + ", subjectNum="
				+ subjectNum + ", examPaperTime=" + examPaperTime + ", examPaperScore=" + examPaperScore + ", division="
				+ division + ", examPaperEasy=" + examPaperEasy + ", grade=" + grade + "]";
	}
