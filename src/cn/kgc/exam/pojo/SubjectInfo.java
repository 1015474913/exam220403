...
public class SubjectInfo implements Serializable {
	...
	public String toString() {
		return "SubjectInfo [subjectId=" + subjectId + ", subjectName=" + subjectName + ", optionA=" + optionA
				+ ", optionB=" + optionB + ", optionC=" + optionC + ", optionD=" + optionD + ", rightResult="
				+ rightResult + ", subjectScore=" + subjectScore + ", subjectType=" + subjectType + ", courseId="
				+ courseId + ", gradeId=" + gradeId + ", subjectEasy=" + subjectEasy + ", division=" + division
				+ ", course=" + course + ", grade=" + grade + ", classInfo=" + classInfo + "]";
	}
