...
<%@page import="cn.kgc.exam.service.StudentinfoServiceImpl"%>
<%@page import="cn.kgc.exam.pojo.ExamPlanInfo"%>
<%@page import="cn.kgc.exam.pojo.StudentInfo"%>
					...
					<c:choose>
						<c:when test="${fn:length(examPlans) > 0 }">
							<c:forEach items="${examPlans }" var="ep">
								<div class="col-md-4">
									<div class="thumbnail">
										<img alt="300x200" src="${pageContext.request.contextPath }/statics/images/reception/peitu1.jpg" />
										<div class="caption">
											<h3>
