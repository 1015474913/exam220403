...
<body>
		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizonta form-signinl" onsubmit="return receptionLoginValidate()" role="form" action="${path }/reception/receptionLogin" method="post" id="receptionLogin" name="receptionLogin">
    ...
    <script src="${path }/statics/js/login.js" charset="UTF-8"></script>
</body>
</html>