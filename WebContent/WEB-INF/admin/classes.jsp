						...
						<c:forEach items="${classes }" var="clazz">
							<tr>
								...
								<td>
									...
									<c:if test="${sessionScope.adminPower == 1 }">
										<div class="btn-group">
											<button type="button" class="btn btn-info btn-sm" onclick="update('${path}/edu/classes/update/${clazz.classId }')">修改</button>
											<button type="button" class="btn btn-danger btn-sm"  onclick="del(${clazz.classId})" >删除</button>
										</div>
									</c:if>
