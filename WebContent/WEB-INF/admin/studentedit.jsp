		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="studentAction" action="${pageContext.request.contextPath }/edu/admin/updateStudent" method="post">
							...
							<div class="col-sm-offset-2 col-sm-4">
								<!-- 
								 <button id="sub" uUrl="student" aUrl="student/student" type="button" class="btn btn-default btn-lg btn-block">
								  ...
								  -->
								  <input type="submit" class="btn btn-default btn-lg btn-block" value="提交"/>
							</div>
						</div>
					</form>
				</div>
