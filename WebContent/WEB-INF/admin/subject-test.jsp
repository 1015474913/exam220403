...
<link href="${path }/statics/js/bootstrap-select/bootstrap-select.min.css"
	rel="stylesheet" />
<link rel="stylesheet" type="text/css"
	href="${path }/statics/js/zeroModal/zeroModal.css" />
<style type="text/css">
.dropdown-toggle {
	height: 30px;
}
...
function subjectUpdate() {
	...
	$.ajax({
		type : "POST",
		data : $("form").serialize(),
		url : "${path }/edu/subject/updateSubject.json",
		dataType:"json",
...
<body>
	...
	<form action="${path }/edu/subject/listSubject"  id="radio-form" >
			...
			<div class="container" style="margin-top:10px;">
				...
				<div class="row clearfix">
						<div class="col-md-12 column" style="margin-top:5px;">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-5" style="padding-left: 43px;width:
								21.5%;margin-left: 0px;">
