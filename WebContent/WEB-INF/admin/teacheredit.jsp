		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="teacherAction" action="/teacher/teacher123" method="post">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								 <button id="sub" uUrl="${path}/edu/teachers/submitteacher" aUrl="${path}/edu/teachers/addsubmitteacher" type="button" class="btn btn-default btn-lg btn-block">
							 		提交
								 </button>
							</div>
						</div>
