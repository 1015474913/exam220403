...
<body>
	<div style="text-align: center;">
		<form:form action="${path}/edu/classes/classSubmit" method="POST" modelAttribute="editClass">
			<!-- 修改情况下才显示编号 -->
			<c:if test="${editClass.classId != null }">
				<b class="form-title">班级编号：</b>
				<form:input class="ipt" path="classId" readonly="readonly" unselectable='on' onfocus='this.blur()' />
			...
			<form:select path="grade.gradeId" items="${grades }"
				itemLabel="gradeName" itemValue="gradeId" class="sel">
			</form:select>
			<br /><br />
