...
<%-- <%@page import="cn.kgc.exam.service.CourseInfoServiceImpl"%> --%>
<%@page import="cn.kgc.exam.pojo.CourseInfo"%>
    	...
    	$(function() {
    		...
    		$("#handlesubmit").click(function() {
    			$.ajax({
    				type : 'POST',
    				data : $('form').serialize(),
    				url : "http://localhost:8080/exam220402/edu/admin/autoAddSubject",
