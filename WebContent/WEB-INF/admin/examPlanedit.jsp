...
<head>
	...
	<c:set var="path" value="<%=basePath %>"></c:set>
 	...
 	<link type="text/css" rel="stylesheet" href="${path}/statics/js/jeDate/test/jeDate-test.css" charset="UTF-8" />
    <link type="text/css" rel="stylesheet" href="${path}/statics/js/jeDate/skin/jedate.css" charset="UTF-8"/>
...
<body>	
		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="examPlanAction" action="${path }/edu/examplan/addExamPlan" method="post">
    ...
    <script type="text/javascript" src="${path }/statics/js/jeDate/src/jedate.js" charset="UTF-8"></script>
