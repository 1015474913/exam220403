						...
						<c:forEach items="${courses }" var="course">
							<tr>
								...
								<td>
									<c:if test="${sessionScope.adminPower == 1 }">
										<div class="btn-group">
											<button type="button" class="btn btn-info btn-sm" onclick="_iframe(1, 'courseedit/${course.courseId }', 'courses')">修改</button>
											<button type="button" class="btn btn-danger btn-sm" onclick="del('${path}/edu/courses/del/${course.courseId }')">删除</button>
										</div>
									</c:if>
								</td>
							</tr>
